...
describe('some function stuff', () => {
  ...
  describe('higher order functions', () => {
    ...
    describe('first practice', () => {
      ...
      it('practice', () => {
        const results = vehicles.filter(x => x.mileage < 200_000).map(x => `${x.make} ${x.model}`) /* your code here */
    ...
    it('practice two', () => {
      ...
      const results: Summary = games.reduce((summary, game) => ({
        ...
        lowScore: game.score < summary.lowScore ? game.score : summary.highScore,
        lowScorer: game.score < summary.lowScore ? game.player : summary.highScorer
      }), {
        highScore: -1,
        highScorer: '',
        lowScore: 301,
